...
import { Check, ArrowRight, Shield, Zap, Target, Layout, Menu, X, ChevronRight, Sparkles, TrendingUp, Users, Clock, Globe, BarChart3, MessageSquare, Smartphone, Rocket } from 'lucide-react';
...
const hamburgerButtonRef = useRef<HTMLButtonElement | null>(null);
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const sections = ['approach', 'process', 'scope', 'audit'];
...
type NavHref = `#${SectionId}`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 overflow-x-hidden">
      ...
      {/* Final CTA */}
      <section id="audit" className="py-20 px-4 sm:px-6 scroll-mt-20">
